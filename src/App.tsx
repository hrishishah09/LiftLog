...
export default function App() {
  ...
  const [activeRoutineId, setActiveRoutineId] = useState<string | null>(SEED_ROUTINES[0]?.id ?? null)
  const [modalOpen, setModalOpen] = useState(false)
  const [history] = useState<SessionRecord[]>(SEED_HISTORY)
