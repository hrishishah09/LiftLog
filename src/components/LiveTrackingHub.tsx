...
import type { Routine, Unit } from '../types'
      ...
      {!routine ? (
        ...
        <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
          <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50">
            <svg viewBox="0 0 24 24" className="h-6 w-6 text-emerald-500" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M20 6 9 17l-5-5" />
            </svg>
          </div>
          <p className="text-sm font-bold text-gray-900">Routine Complete!</p>
          <p className="mt-1 text-xs text-gray-400">Great work. Start another routine when you're ready.</p>
        </div>
      ) : (
